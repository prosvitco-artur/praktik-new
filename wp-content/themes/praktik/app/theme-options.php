...
add_action('carbon_fields_register_fields', function() {
    Container::make('theme_options', __('Theme Settings', 'praktik'))
        ->add_tab(__('Social Media', 'praktik'), [
            ...
            Field::make('text', 'chatbot_url', __('Chatbot URL', 'praktik'))
                ->set_help_text(__('Enter full URL (e.g., https://chatbot.com)', 'praktik'))
                ->set_attribute('placeholder', 'https://chatbot.com/'),
        ])
        ->add_tab( __('Banners', 'praktik'), [
                Field::make('image', 'review_archive_banner', __('Review Archive Banner')),
                Field::make('image', 'apartment_archive_banner', __('Apartment Archive Banner')),
                Field::make('image', 'house_archive_banner', __('House Archive Banner')),
