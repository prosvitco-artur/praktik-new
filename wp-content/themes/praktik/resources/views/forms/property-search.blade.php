  ...
  <form role="search" method="get" class="property-search-form" id="property-search-form">
    <div class="property-search-form__wrapper">
      <div class="property-search-form__field">
        ...
        <select id="property-category" name="property_category" class="property-search-form__select">
          <option value="">{{ __("All category", "praktik") }}</option>
      ...
      <div class="property-search-form__field">
        <label for="property-type" class="property-search-form__label">{{ __("Property type", "praktik") }}</label>
        <select id="property-type" name="property_type" class="property-search-form__select">
